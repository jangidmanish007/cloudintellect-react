...
const DEFAULT_SLIDES = [
  { name: 'Shubham', lastName: 'Khanorkar', designation: 'Sr. Product Manager', package: '18.5', image: 'https://api.builder.io/api/v1/image/assets/TEMP/33c2013dd5b7fc82e1bdf2e56da159309fc675a9?width=940', logo: 'metacube' },
  { name: 'Shivam', lastName: 'Armakar', designation: 'Sr. Project Manager', package: '15.5', image: 'images/vaibhav.webp', logo: 'cognizant' },
  { name: 'Vaibhav', lastName: 'Kawale', designation: 'Sr. Product Manager', package: '14', image: 'images/IMG.webp', logo: 'deloitte' },
  { name: 'Vinay', lastName: 'Jaiswal', designation: 'Sr. Salesforce Developer', package: '11.5', image: 'images/vinay.webp', logo: 'mindsay' }
]
